...
class TestFloat8TrainingHandler(unittest.TestCase):
    ...
    @patch("lightning.pytorch.utilities.fp8_training_handler.is_sm89_or_later", return_value=True)
    ...
    @patch("lightning.pytorch.utilities.fp8_training_handler.is_sm89_or_later", return_value=False)
